# Neo4j & Cypher Crash Course (JKU)

This repository is prepared for introducing **Neo4j** and learning **Cypher Query Language**, for the "Special Topics: Graph Databases" course at Johannes Kepler University (JKU).
